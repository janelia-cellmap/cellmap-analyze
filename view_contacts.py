...
view_in_neuroglancer(
    ...
    cc="/tmp/pytest-of-ackermand/pytest-current/tmpcurrent/tmp_8_8_8.zarr/test_contact_sites_distance_24nm/s0",
    gt="/tmp/pytest-of-ackermand/pytest-current/tmpcurrent/tmp_8_8_8.zarr/contact_sites_distance_24nm/s0",
)
