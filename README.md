...
| **Split Narrow Bridges** | `split-narrow-bridges`       | Split accidentally-merged objects at thin necks/bridges (EDT-watershed or topology-aware skeleton-graph strategies), preserving all original foreground voxels. |
