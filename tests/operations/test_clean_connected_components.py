...
@pytest.mark.parametrize(
    "minimum_volume_voxels, maximum_volume_voxels", [(0, 10), (9, np.inf)]
)
def test_clean_connected_components(
    ...
    ccc = CleanConnectedComponents(
        ...
        output_path=f"{tmp_zarr}/test_clean_connected_components_minimum_volume_nm_3_{minimum_volume_nm_3}_maximum_volume_nm_3_{maximum_volume_nm_3}",
    ...
    test_data = ImageDataInterface(
        f"{tmp_zarr}/test_clean_connected_components_minimum_volume_nm_3_{minimum_volume_nm_3}_maximum_volume_nm_3_{maximum_volume_nm_3}/s0"
    ).to_ndarray_ts()
...
#         f"/tmp/pytest-of-ackermand/pytest-current/tmp0/tmp.zarr/test_clean_connected_components_minimum_volume_nm_3_0_maximum_volume_nm_3_5120/s0"
#     ).to_ndarray_ts(),
#     new_filled=ImageDataInterface(
#         f"/tmp/pytest-of-ackermand/pytest-current/tmp0/tmp.zarr/test_clean_connected_components_minimum_volume_nm_3_4608_maximum_volume_nm_3_inf/s0"
#     ).to_ndarray_ts(),
# )
# %%
